...
minimize fo_desconforto: 
						(sum {t in Ot : AC_Fase_a[w] == 1} (desconforto[z,t,1]))/card(AC)/card(Ot) + 
                        (sum {t in Ot : AC_Fase_b[w] == 1} (desconforto[z,t,2]))/card(AC)/card(Ot) + 
                        (sum {t in Ot : AC_Fase_c[w] == 1} (desconforto[z,t,3]))/card(AC)/card(Ot) ;
